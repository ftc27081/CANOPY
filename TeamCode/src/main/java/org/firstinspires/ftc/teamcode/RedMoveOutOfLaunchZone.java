...
@Autonomous(name = "Red Move out of Launch Zone", group = "Autonomous")
public class RedMoveOutOfLaunchZone extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            sleep(25000);
            encoderDrive(0.25,  35, 5); // move out of zone after shooting
        }
    }
